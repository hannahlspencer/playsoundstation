    ...
    <tr>
      <td>
        <div class="section second-section" id="second">
          <label for="genre">What genre is your game?</label> <br>
          <div class="menu">
      ...
      <td>
        ...
        <div class="section third-section" id="third">
          ...
          <label for="mood">What mood are you looking for?</label> <br>
    ...
    <tr>
      <td>
        <div class="section fourth-section" id="fourth">
          <label for="bars">How long do you want the piece to be?</label>
          <div class="menu">
      ...
      <td>
        <div class="section fifth-section" id="fifth">
          <label for="melody">How many lines of melody would you like?</label> <br>
          <div class="menu">
...
<h2>Convert your MIDI file into an MP3/WAV file with an <a href="https://www.conversion-tool.com/midi">online conversion tool</a></h2>
<div align="center" id="info"><h2>What do these options mean?</h2></div><br>
<p class="definitions"><em>Genre:</em> Genre changes the instruments used and the length of the notes in the bass line.
    Within Genre the options are <br> <ul class="definitions">
...
<p class="definitions"><em>Mood:</em> Mood changes the key, the tempo, the percussion used and the frequency of
    percussive beats each bar<br> <ul class="definitions">
  <li>Downbeat - sets a minor key, a tempo between 80 and 140bpm, and one percussive beat per bar from bass drum,
      crash cymbal, and hi-hat.</li>
  <li>Dreamy - major key, tempo between 80 and 110bpm, and one percussive beat per bar from snare, hi-hat, and
      hand clap. </li>
  <li>Excited - major key, tempo of 110 to 220bpm, two percussive beats per bar from bass drum, hi-hat, crash cymbal,
      and snare.</li>
  ...
  <li>Upbeat - major key, tempo of 120 to 160bpm, three percussive beats per bar from bass drum, hi-hat, crash cymbal,
      and snare.</li>
</ul>
</p>
